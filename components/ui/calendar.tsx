    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 sm:h-7 sm:w-7 bg-transparent p-0 opacity-70 hover:opacity-100 active:bg-accent"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 active:bg-accent"
        ),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-5 w-5 sm:h-4 sm:w-4" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-5 w-5 sm:h-4 sm:w-4" />,
      }}
      {...props}
    />
  );
